...
def get_bot_response():
    ...
    #CompletedProcess(args=['python', 'model/SicoGPT/gpt2.py', 'hello bot how are you'], returncode=0, stdout=', a former member of the National Assembly, said he was "very disappointed" by the decision.\n', stderr='0.01s - Debugger warning: It seems that frozen modules are being used, which may\n0.00s - make the debugger miss breakpoints. Please pass -Xfrozen_modules=off\n0.00s - to python to disable frozen modules.\n0.00s - Note: Debugging will proceed. Set PYDEVD_DISABLE_FILE_VALIDATION=1 to disable this validation.\n')
